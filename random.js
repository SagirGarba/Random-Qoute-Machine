...
function changeQuote(){
    ...
    document.getElementById('general').style.color = "#fff";
    ...
    document.getElementById('new-quote').style.backgroundColor = colors[a];
    document.getElementById('quote-box').style.backgroundColor = "#fff";
...
function tweet(){
    window.open(twitter.com/intent/tweet + " " + quotes[b][0] + " " + quotes[b][1]);
};
